...
urlpatterns = [
    ...
    url(r'^(?P<league_name>[a-zA-z0-9]+)/player_histories/$', views.player_histories_main, name='player_histories_main'),    
    url(r'^(?P<league_name>[a-zA-z0-9]+)/player_histories/(?P<username>[a-zA-Z0-9@.+-_]+)/$', views.player_histories, name='player_histories'),
